...
#define ALREADY_HOUSE_GOSSIP_MESSAGE "Vosotros ya teneis el GuildHouse : %s"
#define MSG_GOSSIP_TELE "Teleportarse al lugar del GuildHouse"
#define MSG_GOSSIP_BUY "Comprar el GuildHouse (25000g)"
#define MSG_GOSSIP_SELL "Vender el GuildHouse (10000g)"
#define MSG_GOSSIP_NEXTPAGE "Siguiente -->"
#define MSG_INCOMBAT "No puedes ser teleportado a la GuildHouse porque estas en combate."
#define MSG_NOGUILDHOUSE "Vuestra guild no tiene comprada una GuildHouse."
#define MSG_NOFREEGH "Por desgracia, todas las GuildHouses ya estan compradas."
#define MSG_ALREADYHAVEGH "D, ya tienes una GuildHouse (%s)."
#define MSG_NOTENOUGHMONEY "No tienes los %u oros necesarios para comprar un GuildHouse."
#define MSG_GHOCCUPIED "La GuildHouse no esta disponible para la venta o esta ocupada."
#define MSG_CONGRATULATIONS "Felicitaciones!, acabas de adquirir la GuildHouse para tu Hermandad."
#define MSG_SOLD "Has vendido la GuildHouse en %u oros"
#define MSG_NOTINGUILD "Necesitas estar en una Hermandad antes de poder comprar un GuildHouse."
...
#define COST_GH_BUY 250000000  //25000 g.
#define COST_GH_SELL 100000000 //10000 g.
