...
class spell_boss_bronjahm_soulstorm : public SpellScriptLoader
{
    public:
        spell_boss_bronjahm_soulstorm() : SpellScriptLoader("spell_boss_bronjahm_soulstorm") { }

        class spell_boss_bronjahm_soulstorm_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_boss_bronjahm_soulstorm_SpellScript);
            ...
            void FilterTargets(std::list<Unit*>& unitList)
            {
                ...
                {
                    if( (*it)->GetDistance(GetCaster()) < 10.0f )
            ...
            void Register()
            {
                OnUnitTargetSelect += SpellUnitTargetFn(spell_boss_bronjahm_soulstorm_SpellScript::FilterTargets, EFFECT_1, TARGET_DST_CASTER);
                OnUnitTargetSelect += SpellUnitTargetFn(spell_boss_bronjahm_soulstorm_SpellScript::FilterTargets, EFFECT_2, TARGET_DST_CASTER);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_boss_bronjahm_soulstorm_SpellScript();
        }
};
...
void AddSC_boss_bronjahm()
{
    ...
    new spell_boss_bronjahm_soulstorm();
}
