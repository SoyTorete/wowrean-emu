...
void DespawnInvadersInVioletHold(WorldObject *ref)
{
    const uint32 mobsToDespawn[19] = {
        ...
        CREATURE_PORTAL_KEEPER
    };
    for (uint8 i = 0; i < 19; ++i)
        while (Unit *unit = ref->FindNearestCreature(mobsToDespawn[i], 200.0f, true))
