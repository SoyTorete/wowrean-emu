...
void World::LoadConfigSettings(bool reload)
{
    ...
    // Dungeon finder
    m_bool_configs[CONFIG_DUNGEON_FINDER_ENABLE] = sConfig->GetBoolDefault("DungeonFinder.Enable", true);
...
void World::SetInitialWorldSettings()
{
    ...
    sLog->outString();
    sLog->outString("WORLD: World is initialized in %u minute(s) %u seconds", (startupDuration / 60000), ((startupDuration % 60000) / 1000) );
    sLog->outString();
}
