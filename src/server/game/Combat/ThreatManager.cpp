...
bool ThreatCalcHelper::isValidProcess(Unit *pHatedUnit, Unit* pHatingUnit, SpellEntry const *pThreatSpell)
{
...
{
    if (!(ThreatCalcHelper::isValidProcess(pVictim, getOwner(), pThreatSpell)))
        return;
