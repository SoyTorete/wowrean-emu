...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand lookupCommandTable[] =
    {
        ...
        { "item",           0,  true,  OldHandler<&ChatHandler::HandleLookupItemCommand>,          "", NULL },
        { "itemset",        0,  true,  OldHandler<&ChatHandler::HandleLookupItemSetCommand>,       "", NULL },
        ...
        { "tele",           0,      true,  OldHandler<&ChatHandler::HandleLookupTeleCommand>,          "", NULL },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "lookup",         0,  true,  NULL,                                           "", lookupCommandTable   },
